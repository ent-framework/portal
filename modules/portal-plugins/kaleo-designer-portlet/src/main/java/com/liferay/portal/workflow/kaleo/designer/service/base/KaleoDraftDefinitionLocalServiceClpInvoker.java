...
public class KaleoDraftDefinitionLocalServiceClpInvoker {
	...
	public Object invokeMethod(String name, String[] parameterTypes,
		...
		if (_methodName35.equals(name) &&
			...
			KaleoDraftDefinitionLocalServiceUtil.setBeanIdentifier((String)arguments[0]);
		...
		if (_methodName41.equals(name) &&
			...
			return KaleoDraftDefinitionLocalServiceUtil.deleteKaleoDraftDefinition((String)arguments[0],
				((Integer)arguments[1]).intValue(),
				((Integer)arguments[2]).intValue(),
		...
		if (_methodName42.equals(name) &&
			...
			KaleoDraftDefinitionLocalServiceUtil.deleteKaleoDraftDefinitions((String)arguments[0],
				((Integer)arguments[1]).intValue(),
		...
		if (_methodName43.equals(name) &&
			...
			return KaleoDraftDefinitionLocalServiceUtil.getKaleoDraftDefinition((String)arguments[0],
				((Integer)arguments[1]).intValue(),
				((Integer)arguments[2]).intValue(),
				(com.liferay.portal.service.ServiceContext)arguments[3]);
		}
		...
		if (_methodName44.equals(name) &&
			...
			return KaleoDraftDefinitionLocalServiceUtil.getKaleoDraftDefinitions((String)arguments[0],
				((Integer)arguments[1]).intValue(),
				((Integer)arguments[2]).intValue(),
		...
		if (_methodName45.equals(name) &&
			...
			return KaleoDraftDefinitionLocalServiceUtil.getKaleoDraftDefinitionsCount((String)arguments[0],
				((Integer)arguments[1]).intValue(),
				(com.liferay.portal.service.ServiceContext)arguments[2]);
		}
		...
		if (_methodName46.equals(name) &&
			...
			return KaleoDraftDefinitionLocalServiceUtil.getLatestKaleoDraftDefinition((String)arguments[0],
				((Integer)arguments[1]).intValue(),
				(com.liferay.portal.service.ServiceContext)arguments[2]);
		}
