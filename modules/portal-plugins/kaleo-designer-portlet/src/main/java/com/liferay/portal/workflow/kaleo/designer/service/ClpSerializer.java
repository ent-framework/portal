...
import com.liferay.portal.workflow.kaleo.designer.model.KaleoDraftDefinitionClp;
...
public class ClpSerializer {
        ...
        synchronized (ClpSerializer.class) {
            ...
            try {
                ...
                String portletPropsServletContextName = (String) getMethod.invoke(null,
                        "kaleo-designer-portlet-deployment-context");
            ...
            if (Validator.isNull(_servletContextName)) {
                _servletContextName = "kaleo-designer-portlet";
            }
    ...
    public static Object translateInput(BaseModel<?> oldModel) {
        ...
        if (oldModelClassName.equals(KaleoDraftDefinitionClp.class.getName())) {
            return translateInputKaleoDraftDefinition(oldModel);
        }
    ...
    public static Object translateInputKaleoDraftDefinition(
        BaseModel<?> oldModel) {
        KaleoDraftDefinitionClp oldClpModel = (KaleoDraftDefinitionClp) oldModel;

        BaseModel<?> newModel = oldClpModel.getKaleoDraftDefinitionRemoteModel();
    ...
    public static Object translateOutput(BaseModel<?> oldModel) {
        ...
        if (oldModelClassName.equals(
            ...
            return translateOutputKaleoDraftDefinition(oldModel);
    ...
    public static Object translateOutputKaleoDraftDefinition(
        BaseModel<?> oldModel) {
        KaleoDraftDefinitionClp newModel = new KaleoDraftDefinitionClp();

        newModel.setModelAttributes(oldModel.getModelAttributes());

        newModel.setKaleoDraftDefinitionRemoteModel(oldModel);
