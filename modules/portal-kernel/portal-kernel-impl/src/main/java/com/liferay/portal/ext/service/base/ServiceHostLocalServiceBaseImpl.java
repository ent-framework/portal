...
import com.liferay.portal.ext.service.ServiceHostLocalService;
...
/**
 * Provides the base implementation for the service host local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.liferay.portal.ext.service.impl.ServiceHostLocalServiceImpl}.
 * </p>
 *
 * @author Jeff Qian
 ...
 * @generated
 */
public abstract class ServiceHostLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements ServiceHostLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.liferay.portal.ext.service.ServiceHostLocalServiceUtil} to access the service host local service.
	 */
	...
	@Override
	public ServiceHost addServiceHost(ServiceHost serviceHost)
		throws SystemException {
		serviceHost.setNew(true);

		return serviceHostPersistence.update(serviceHost);
	}
	 ...
	 */
	@Override
	public ServiceHost createServiceHost(long hostId) {
		return serviceHostPersistence.create(hostId);
	}
	...
	@Override
	public ServiceHost deleteServiceHost(long hostId)
		throws PortalException, SystemException {
		return serviceHostPersistence.remove(hostId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public ServiceHost deleteServiceHost(ServiceHost serviceHost)
		throws SystemException {
		return serviceHostPersistence.remove(serviceHost);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(ServiceHost.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return serviceHostPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
		throws SystemException {
		return serviceHostPersistence.findWithDynamicQuery(dynamicQuery, start,
			end);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return serviceHostPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public ServiceHost fetchServiceHost(long hostId) throws SystemException {
		return serviceHostPersistence.fetchByPrimaryKey(hostId);
	}
	 ...
	 */
	@Override
	public ServiceHost getServiceHost(long hostId)
		throws PortalException, SystemException {
		return serviceHostPersistence.findByPrimaryKey(hostId);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return serviceHostPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<ServiceHost> getServiceHosts(int start, int end)
		throws SystemException {
		return serviceHostPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getServiceHostsCount() throws SystemException {
		return serviceHostPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public ServiceHost updateServiceHost(ServiceHost serviceHost)
		throws SystemException {
		return serviceHostPersistence.update(serviceHost);
	}
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("com.liferay.portal.ext.model.ServiceHost",
			serviceHostLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"com.liferay.portal.ext.model.ServiceHost");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = serviceHostPersistence.getDataSource();
