...
import com.liferay.portal.ext.service.ServiceParamLocalService;
...
/**
 * Provides the base implementation for the service param local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.liferay.portal.ext.service.impl.ServiceParamLocalServiceImpl}.
 * </p>
 *
 * @author Jeff Qian
 ...
 * @generated
 */
public abstract class ServiceParamLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements ServiceParamLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.liferay.portal.ext.service.ServiceParamLocalServiceUtil} to access the service param local service.
	 */
	...
	@Override
	public ServiceParam addServiceParam(ServiceParam serviceParam)
		throws SystemException {
		serviceParam.setNew(true);

		return serviceParamPersistence.update(serviceParam);
	}
	 ...
	 */
	@Override
	public ServiceParam createServiceParam(long paramId) {
		return serviceParamPersistence.create(paramId);
	}
	...
	@Override
	public ServiceParam deleteServiceParam(long paramId)
		throws PortalException, SystemException {
		return serviceParamPersistence.remove(paramId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public ServiceParam deleteServiceParam(ServiceParam serviceParam)
		throws SystemException {
		return serviceParamPersistence.remove(serviceParam);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(ServiceParam.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return serviceParamPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return serviceParamPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public ServiceParam fetchServiceParam(long paramId)
		throws SystemException {
		return serviceParamPersistence.fetchByPrimaryKey(paramId);
	}
	 ...
	 */
	@Override
	public ServiceParam getServiceParam(long paramId)
		throws PortalException, SystemException {
		return serviceParamPersistence.findByPrimaryKey(paramId);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return serviceParamPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<ServiceParam> getServiceParams(int start, int end)
		throws SystemException {
		return serviceParamPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getServiceParamsCount() throws SystemException {
		return serviceParamPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public ServiceParam updateServiceParam(ServiceParam serviceParam)
		throws SystemException {
		return serviceParamPersistence.update(serviceParam);
	}
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("com.liferay.portal.ext.model.ServiceParam",
			serviceParamLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"com.liferay.portal.ext.model.ServiceParam");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = serviceParamPersistence.getDataSource();
