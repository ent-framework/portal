...
import com.liferay.portal.ext.service.FilterGroupLocalService;
...
/**
 * Provides the base implementation for the filter group local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.liferay.portal.ext.service.impl.FilterGroupLocalServiceImpl}.
 * </p>
 *
 * @author Jeff Qian
 ...
 * @generated
 */
public abstract class FilterGroupLocalServiceBaseImpl
    extends BaseLocalServiceImpl implements FilterGroupLocalService,
        IdentifiableBean {
     ...
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link com.liferay.portal.ext.service.FilterGroupLocalServiceUtil} to access the filter group local service.
     */
    ...
    public FilterGroup addFilterGroup(FilterGroup filterGroup)
        ...
        return filterGroupPersistence.update(filterGroup);
    }
     ...
     */
    @Override
    public FilterGroup createFilterGroup(long filterGroupId) {
        return filterGroupPersistence.create(filterGroupId);
    }
    ...
    @Override
    public FilterGroup deleteFilterGroup(long filterGroupId)
        throws PortalException, SystemException {
        return filterGroupPersistence.remove(filterGroupId);
    }
    ...
    @Indexable(type = IndexableType.DELETE)
    @Override
    public FilterGroup deleteFilterGroup(FilterGroup filterGroup)
        throws SystemException {
        return filterGroupPersistence.remove(filterGroup);
    }
    ...
    public DynamicQuery dynamicQuery() {
        ...
        return DynamicQueryFactoryUtil.forClass(FilterGroup.class,
    ...
    public List dynamicQuery(DynamicQuery dynamicQuery)
        throws SystemException {
        return filterGroupPersistence.findWithDynamicQuery(dynamicQuery);
    }
    ...
    public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
        throws SystemException {
        return filterGroupPersistence.findWithDynamicQuery(dynamicQuery, start,
            end);
    }
    ...
    public long dynamicQueryCount(DynamicQuery dynamicQuery)
        throws SystemException {
        return filterGroupPersistence.countWithDynamicQuery(dynamicQuery);
    }
    ...
    @Override
    public FilterGroup fetchFilterGroup(long filterGroupId)
        throws SystemException {
        return filterGroupPersistence.fetchByPrimaryKey(filterGroupId);
    }
     ...
     */
    @Override
    public FilterGroup fetchFilterGroupByUuidAndGroupId(String uuid,
        long groupId) throws SystemException {
        return filterGroupPersistence.fetchByUUID_G(uuid, groupId);
    }
     ...
     */
    @Override
    public FilterGroup getFilterGroup(long filterGroupId)
        throws PortalException, SystemException {
        return filterGroupPersistence.findByPrimaryKey(filterGroupId);
    }

    @Override
    public PersistedModel getPersistedModel(Serializable primaryKeyObj)
        throws PortalException, SystemException {
        return filterGroupPersistence.findByPrimaryKey(primaryKeyObj);
    }
     ...
     */
    @Override
    public FilterGroup getFilterGroupByUuidAndGroupId(String uuid, long groupId)
        throws PortalException, SystemException {
        return filterGroupPersistence.findByUUID_G(uuid, groupId);
    }
     ...
     */
    @Override
    public List<FilterGroup> getFilterGroups(int start, int end)
        throws SystemException {
        return filterGroupPersistence.findAll(start, end);
    }
     ...
     */
    @Override
    public int getFilterGroupsCount() throws SystemException {
        return filterGroupPersistence.countAll();
    }
    ...
    @Indexable(type = IndexableType.REINDEX)
    @Override
    public FilterGroup updateFilterGroup(FilterGroup filterGroup)
        throws SystemException {
        return filterGroupPersistence.update(filterGroup);
    }
    ...
    public void afterPropertiesSet() {
        persistedModelLocalServiceRegistry.register("com.liferay.portal.ext.model.FilterGroup",
            filterGroupLocalService);
    }

    public void destroy() {
        persistedModelLocalServiceRegistry.unregister(
            "com.liferay.portal.ext.model.FilterGroup");
    }
    ...
    protected void runSQL(String sql) throws SystemException {
        try {
            DataSource dataSource = filterGroupPersistence.getDataSource();
