...
public class PublishServiceServlet extends JSONServlet {
	...
	public void service(
		...
		String apiPath = PortalUtil.getPathMain() + "/portal/api/json_publish";
...
/*			else {
				...
				String redirectPath =
					PortalUtil.getPathContext() + "/api/json_remote?serviceTag=" +
	...
	protected JSONAction getJSONAction(ServletContext servletContext) {
		PublishServiceAction remoteServcieAction = new PublishServiceAction();
		return remoteServcieAction;
	}

	private static Log _log = LogFactoryUtil.getLog(PublishServiceServlet.class);	
