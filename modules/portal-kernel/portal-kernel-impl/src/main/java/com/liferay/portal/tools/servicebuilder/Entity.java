...
public class Entity {
	...
	public Entity(String name) {
		this(
			null, null, null, null, name, null, null, null, false, false, false, true,
			null, null, null, null, null, true, false, false, false, null, null,
			null, null, null, null, null, null, null);
	}

	public Entity(
		String packagePath, String portletName, String portletShortName, String extend,
	...
	public void setParent(Entity parent){
		...
		checkColumns(parent.getRegularColList(), _regularColList);
		
		_parent = parent;	
		_pkList.addAll(parent.getPKList());
		//change table name
		_table = parent.getTable();	
		
	}
	
	private void checkColumns(List<EntityColumn> parent, List<EntityColumn> children) {
		if (parent==null || parent.size()==0) return;
		
		for (EntityColumn column : children) {
			if (parent.contains(column)) {
				throw new RuntimeException("Parent contains column : " + column.getName());
			}
		}
	}
