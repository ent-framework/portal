 ...
 * @author Shuyang Zhou
 */
public class EurekaClusterForwardReceiver extends BaseReceiver {

    public EurekaClusterForwardReceiver(
    ...
    protected void doReceive(Message message) {
        ...
        if (!_localTransportAddress.equals(message.getSrc()) ||
    ...
    private static final Logger _log = LoggerFactory.getLogger(
            EurekaClusterForwardReceiver.class);
