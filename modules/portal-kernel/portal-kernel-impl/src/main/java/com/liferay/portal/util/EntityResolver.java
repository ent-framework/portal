...
public class EntityResolver implements org.xml.sax.EntityResolver {
	...
	public InputSource resolveEntity(String publicId, String systemId) {
		...
		if (publicId != null) {
			for (int i = 0; i < PUBLIC_IDS.length; i++) {
				KeyValuePair kvp = PUBLIC_IDS[i];

				if (publicId.equals(kvp.getKey())) {
					InputStream is = classLoader.getResourceAsStream(
						DEFINITIONS_PATH + kvp.getValue());
	...
	public static final String DEFINITIONS_PATH =
		"com/liferay/portal/definitions/";

	public static final KeyValuePair[] PUBLIC_IDS = {
		new KeyValuePair(
		...
		new KeyValuePair(
				"-//Liferay//DTD Service Builder 6.3.0//EN",
				"liferay-service-builder_6_3_0.dtd"
		),
