...
public class HookHotDeployListener
	...
	protected void initServletFilters(
		...
		for (Element servletFilterElement : servletFilterElements) {
			...
			filterMappings.put(servletFilterName, servletFilterImpl);
			...
			servletFiltersContainer.registerFilterScope(
					servletFilterName, servletFilterImpl, servletContextName);
		}
		...
		for (Element servletFilterMappingElement :
			...
			servletFiltersContainer.registerFilterMapping(
				servletFilterName, filterMappings.get(servletFilterName) , urlPatterns, dispatchers, positionFilterName,
				after);
		}
	}
	...
	private class ServletFiltersContainer {
		...
		public void registerFilterScope(String filterName, String filterClassName, String contextPath) {
			...
			invokerFilterHelper.registerFilterScope(filterName, filterClassName, contextPath);			
		}
		...
		public void registerFilterMapping(
			String filterName, String filterClassName, List<String> urlPatterns,
			...
			FilterMapping filterMapping = new FilterMapping(filterName, filterClassName,
