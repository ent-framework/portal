...
//		}
	...
	public void initCustomSQL() {
		_customSqlKeys = new String[] {
				...
				"[$CLASS_NAME_ID_COM.LIFERAY.PORTLET.BOOKMARKS.MODEL." + "BOOKMARKSFOLDER$]",
				...
				"[$CLASS_NAME_ID_COM.LIFERAY.PORTLET.JOURNAL.MODEL." + "JOURNALFOLDER$]",
