...
import com.liferay.portal.ext.service.ModelConnectionEntryLocalService;
...
/**
 * Provides the base implementation for the model connection entry local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.liferay.portal.ext.service.impl.ModelConnectionEntryLocalServiceImpl}.
 * </p>
 *
 * @author Jeff Qian
 ...
 * @generated
 */
public abstract class ModelConnectionEntryLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements ModelConnectionEntryLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.liferay.portal.ext.service.ModelConnectionEntryLocalServiceUtil} to access the model connection entry local service.
	 */
	...
	@Override
	public ModelConnectionEntry addModelConnectionEntry(
		ModelConnectionEntry modelConnectionEntry) throws SystemException {
		modelConnectionEntry.setNew(true);

		return modelConnectionEntryPersistence.update(modelConnectionEntry);
	}
	 ...
	 */
	@Override
	public ModelConnectionEntry createModelConnectionEntry(long entryId) {
		return modelConnectionEntryPersistence.create(entryId);
	}
	...
	@Override
	public ModelConnectionEntry deleteModelConnectionEntry(long entryId)
		throws PortalException, SystemException {
		return modelConnectionEntryPersistence.remove(entryId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public ModelConnectionEntry deleteModelConnectionEntry(
		ModelConnectionEntry modelConnectionEntry) throws SystemException {
		return modelConnectionEntryPersistence.remove(modelConnectionEntry);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(ModelConnectionEntry.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return modelConnectionEntryPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return modelConnectionEntryPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public ModelConnectionEntry fetchModelConnectionEntry(long entryId)
		throws SystemException {
		return modelConnectionEntryPersistence.fetchByPrimaryKey(entryId);
	}
	 ...
	 */
	@Override
	public ModelConnectionEntry getModelConnectionEntry(long entryId)
		throws PortalException, SystemException {
		return modelConnectionEntryPersistence.findByPrimaryKey(entryId);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return modelConnectionEntryPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<ModelConnectionEntry> getModelConnectionEntries(int start,
		int end) throws SystemException {
		return modelConnectionEntryPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getModelConnectionEntriesCount() throws SystemException {
		return modelConnectionEntryPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public ModelConnectionEntry updateModelConnectionEntry(
		ModelConnectionEntry modelConnectionEntry) throws SystemException {
		return modelConnectionEntryPersistence.update(modelConnectionEntry);
	}
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("com.liferay.portal.ext.model.ModelConnectionEntry",
			modelConnectionEntryLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"com.liferay.portal.ext.model.ModelConnectionEntry");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = modelConnectionEntryPersistence.getDataSource();
