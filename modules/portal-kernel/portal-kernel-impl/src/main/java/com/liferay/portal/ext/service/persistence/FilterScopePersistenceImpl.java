...
public class FilterScopePersistenceImpl extends BasePersistenceImpl<FilterScope>
	...
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_FIND_BY_CONTEXTPATH =
		new FinderPath(FilterScopeModelImpl.ENTITY_CACHE_ENABLED,
			FilterScopeModelImpl.FINDER_CACHE_ENABLED, FilterScopeImpl.class,
			FINDER_CLASS_NAME_LIST_WITH_PAGINATION, "findByContextPath",
			new String[] {
	...
	public static final FinderPath FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_CONTEXTPATH =
		new FinderPath(FilterScopeModelImpl.ENTITY_CACHE_ENABLED,
			FilterScopeModelImpl.FINDER_CACHE_ENABLED, FilterScopeImpl.class,
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "findByContextPath",
			new String[] { String.class.getName() },
			FilterScopeModelImpl.CONTEXTPATH_COLUMN_BITMASK |
			FilterScopeModelImpl.CLASSNAME_COLUMN_BITMASK);
	public static final FinderPath FINDER_PATH_COUNT_BY_CONTEXTPATH = new FinderPath(FilterScopeModelImpl.ENTITY_CACHE_ENABLED,
			FilterScopeModelImpl.FINDER_CACHE_ENABLED, Long.class,
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "countByContextPath",
			new String[] { String.class.getName() });
	 ...
	 */
	@Override
	public List<FilterScope> findByContextPath(String contextPath)
		throws SystemException {
		return findByContextPath(contextPath, QueryUtil.ALL_POS,
	 ...
	 */
	@Override
	public List<FilterScope> findByContextPath(String contextPath, int start,
		int end) throws SystemException {
		return findByContextPath(contextPath, start, end, null);
	}
	...
	public List<FilterScope> findByContextPath(String contextPath, int start,
		...
		if ((start == QueryUtil.ALL_POS) && (end == QueryUtil.ALL_POS) &&
			...
			pagination = false;
			finderPath = FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_CONTEXTPATH;
			finderArgs = new Object[] { contextPath };
		}
		else {
			finderPath = FINDER_PATH_WITH_PAGINATION_FIND_BY_CONTEXTPATH;
			finderArgs = new Object[] { contextPath, start, end, orderByComparator };
		}
		...
		if ((list != null) && !list.isEmpty()) {
			for (FilterScope filterScope : list) {
				if (!Validator.equals(contextPath, filterScope.getContextPath())) {
					list = null;
		...
		if (list == null) {
			...
			boolean bindContextPath = false;

			if (contextPath == null) {
				query.append(_FINDER_COLUMN_CONTEXTPATH_CONTEXTPATH_1);
			}
			else if (contextPath.equals(StringPool.BLANK)) {
				query.append(_FINDER_COLUMN_CONTEXTPATH_CONTEXTPATH_3);
			}
			else {
				bindContextPath = true;

				query.append(_FINDER_COLUMN_CONTEXTPATH_CONTEXTPATH_2);
			}
	 ...
	 */
	@Override
	public FilterScope findByContextPath_First(String contextPath,
		OrderByComparator orderByComparator)
		throws NoSuchFilterScopeException, SystemException {
		FilterScope filterScope = fetchByContextPath_First(contextPath,
				orderByComparator);
	 ...
	 */
	@Override
	public FilterScope fetchByContextPath_First(String contextPath,
		OrderByComparator orderByComparator) throws SystemException {
		List<FilterScope> list = findByContextPath(contextPath, 0, 1,
				orderByComparator);
	 ...
	 */
	@Override
	public FilterScope findByContextPath_Last(String contextPath,
		OrderByComparator orderByComparator)
		throws NoSuchFilterScopeException, SystemException {
		FilterScope filterScope = fetchByContextPath_Last(contextPath,
				orderByComparator);
	 ...
	 */
	@Override
	public FilterScope fetchByContextPath_Last(String contextPath,
		OrderByComparator orderByComparator) throws SystemException {
		int count = countByContextPath(contextPath);

		if (count == 0) {
			return null;
		}

		List<FilterScope> list = findByContextPath(contextPath, count - 1,
	 ...
	 */
	@Override
	public FilterScope[] findByContextPath_PrevAndNext(long filterScopeId,
		String contextPath, OrderByComparator orderByComparator)
		throws NoSuchFilterScopeException, SystemException {
		...
		try {
			...
			array[0] = getByContextPath_PrevAndNext(session, filterScope,
					contextPath, orderByComparator, true);

			array[1] = filterScope;

			array[2] = getByContextPath_PrevAndNext(session, filterScope,
					contextPath, orderByComparator, false);
	...
	protected FilterScope getByContextPath_PrevAndNext(Session session,
		FilterScope filterScope, String contextPath,
	 ...
	 */
	@Override
	public void removeByContextPath(String contextPath)
		throws SystemException {
		for (FilterScope filterScope : findByContextPath(contextPath,
	...
	public int countByContextPath(String contextPath) throws SystemException {
		FinderPath finderPath = FINDER_PATH_COUNT_BY_CONTEXTPATH;

		Object[] finderArgs = new Object[] { contextPath };
	...
	private static final String _FINDER_COLUMN_CONTEXTPATH_CONTEXTPATH_1 = "filterScope.contextPath IS NULL";
	private static final String _FINDER_COLUMN_CONTEXTPATH_CONTEXTPATH_2 = "filterScope.contextPath = ?";
	private static final String _FINDER_COLUMN_CONTEXTPATH_CONTEXTPATH_3 = "(filterScope.contextPath IS NULL OR filterScope.contextPath = '')";
	public static final FinderPath FINDER_PATH_FETCH_BY_FCC = new FinderPath(FilterScopeModelImpl.ENTITY_CACHE_ENABLED,
			FilterScopeModelImpl.FINDER_CACHE_ENABLED, FilterScopeImpl.class,
			FINDER_CLASS_NAME_ENTITY, "fetchByFCC",
			new String[] {
			...
			FilterScopeModelImpl.CLASSNAME_COLUMN_BITMASK |
			FilterScopeModelImpl.CONTEXTPATH_COLUMN_BITMASK);
	public static final FinderPath FINDER_PATH_COUNT_BY_FCC = new FinderPath(FilterScopeModelImpl.ENTITY_CACHE_ENABLED,
			FilterScopeModelImpl.FINDER_CACHE_ENABLED, Long.class,
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "countByFCC",
			new String[] {
				String.class.getName(), String.class.getName(),
				String.class.getName()
			});
	 ...
	 */
	@Override
	public FilterScope findByFCC(String filterName, String className,
		String contextPath) throws NoSuchFilterScopeException, SystemException {
		FilterScope filterScope = fetchByFCC(filterName, className, contextPath);
	 ...
	 */
	@Override
	public FilterScope fetchByFCC(String filterName, String className,
		String contextPath) throws SystemException {
		return fetchByFCC(filterName, className, contextPath, true);
	}
	...
	@Override
	public FilterScope fetchByFCC(String filterName, String className,
		String contextPath, boolean retrieveFromCache)
		throws SystemException {
		Object[] finderArgs = new Object[] { filterName, className, contextPath };

		Object result = null;

		if (retrieveFromCache) {
			result = FinderCacheUtil.getResult(FINDER_PATH_FETCH_BY_FCC,
					finderArgs, this);
		}
		...
		if (result instanceof FilterScope) {
			...
			if (!Validator.equals(filterName, filterScope.getFilterName()) ||
					!Validator.equals(className, filterScope.getClassName()) ||
					!Validator.equals(contextPath, filterScope.getContextPath())) {
				result = null;
			}
		}
		...
		if (result == null) {
			...
			if (filterName == null) {
				query.append(_FINDER_COLUMN_FCC_FILTERNAME_1);
			}
			else if (filterName.equals(StringPool.BLANK)) {
				query.append(_FINDER_COLUMN_FCC_FILTERNAME_3);
			}
			else {
				bindFilterName = true;

				query.append(_FINDER_COLUMN_FCC_FILTERNAME_2);
			}

			boolean bindClassName = false;

			if (className == null) {
				query.append(_FINDER_COLUMN_FCC_CLASSNAME_1);
			}
			else if (className.equals(StringPool.BLANK)) {
				query.append(_FINDER_COLUMN_FCC_CLASSNAME_3);
			}
			else {
				bindClassName = true;

				query.append(_FINDER_COLUMN_FCC_CLASSNAME_2);
			}

			boolean bindContextPath = false;

			if (contextPath == null) {
				query.append(_FINDER_COLUMN_FCC_CONTEXTPATH_1);
			}
			else if (contextPath.equals(StringPool.BLANK)) {
				query.append(_FINDER_COLUMN_FCC_CONTEXTPATH_3);
			}
			else {
				bindContextPath = true;

				query.append(_FINDER_COLUMN_FCC_CONTEXTPATH_2);
			}
			...
			try {
				...
				if (list.isEmpty()) {
					FinderCacheUtil.putResult(FINDER_PATH_FETCH_BY_FCC,
						finderArgs, list);
				}
				else {
					...
					if ((filterScope.getFilterName() == null) ||
							!filterScope.getFilterName().equals(filterName) ||
							(filterScope.getClassName() == null) ||
							!filterScope.getClassName().equals(className) ||
							(filterScope.getContextPath() == null) ||
							!filterScope.getContextPath().equals(contextPath)) {
						FinderCacheUtil.putResult(FINDER_PATH_FETCH_BY_FCC,
				...
				FinderCacheUtil.removeResult(FINDER_PATH_FETCH_BY_FCC,
					finderArgs);
	 ...
	 */
	@Override
	public FilterScope removeByFCC(String filterName, String className,
		String contextPath) throws NoSuchFilterScopeException, SystemException {
		FilterScope filterScope = findByFCC(filterName, className, contextPath);
	 ...
	 */
	@Override
	public int countByFCC(String filterName, String className,
		String contextPath) throws SystemException {
		FinderPath finderPath = FINDER_PATH_COUNT_BY_FCC;
	...
	private static final String _FINDER_COLUMN_FCC_FILTERNAME_1 = "filterScope.filterName IS NULL AND ";
	private static final String _FINDER_COLUMN_FCC_FILTERNAME_2 = "filterScope.filterName = ? AND ";
	private static final String _FINDER_COLUMN_FCC_FILTERNAME_3 = "(filterScope.filterName IS NULL OR filterScope.filterName = '') AND ";
	private static final String _FINDER_COLUMN_FCC_CLASSNAME_1 = "filterScope.className IS NULL AND ";
	private static final String _FINDER_COLUMN_FCC_CLASSNAME_2 = "filterScope.className = ? AND ";
	private static final String _FINDER_COLUMN_FCC_CLASSNAME_3 = "(filterScope.className IS NULL OR filterScope.className = '') AND ";
	private static final String _FINDER_COLUMN_FCC_CONTEXTPATH_1 = "filterScope.contextPath IS NULL";
	private static final String _FINDER_COLUMN_FCC_CONTEXTPATH_2 = "filterScope.contextPath = ?";
	private static final String _FINDER_COLUMN_FCC_CONTEXTPATH_3 = "(filterScope.contextPath IS NULL OR filterScope.contextPath = '')";
	...
	public void cacheResult(FilterScope filterScope) {
		...
		FinderCacheUtil.putResult(FINDER_PATH_FETCH_BY_FCC,
			new Object[] {
				filterScope.getFilterName(), filterScope.getClassName(),
				filterScope.getContextPath()
			}, filterScope);
	...
	protected void cacheUniqueFindersCache(FilterScope filterScope) {
		if (filterScope.isNew()) {
			...
			FinderCacheUtil.putResult(FINDER_PATH_COUNT_BY_FCC, args,
				Long.valueOf(1));
			FinderCacheUtil.putResult(FINDER_PATH_FETCH_BY_FCC, args,
				filterScope);
		}
		else {
			...
			if ((filterScopeModelImpl.getColumnBitmask() &
					FINDER_PATH_FETCH_BY_FCC.getColumnBitmask()) != 0) {
				Object[] args = new Object[] {
						filterScope.getFilterName(), filterScope.getClassName(),
						filterScope.getContextPath()
					};
	...
	protected void clearUniqueFindersCache(FilterScope filterScope) {
		...
		FinderCacheUtil.removeResult(FINDER_PATH_COUNT_BY_FCC, args);
		FinderCacheUtil.removeResult(FINDER_PATH_FETCH_BY_FCC, args);
		...
		if ((filterScopeModelImpl.getColumnBitmask() &
			...
			args = new Object[] {
					...
					filterScopeModelImpl.getOriginalContextPath()
				};
	...
	public FilterScope updateImpl(
		...
		if (isNew || !FilterScopeModelImpl.COLUMN_BITMASK_ENABLED) {
			...
			if ((filterScopeModelImpl.getColumnBitmask() &
					FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_CONTEXTPATH.getColumnBitmask()) != 0) {
				Object[] args = new Object[] {
						filterScopeModelImpl.getOriginalContextPath()
					};

				FinderCacheUtil.removeResult(FINDER_PATH_COUNT_BY_CONTEXTPATH,
					args);
				FinderCacheUtil.removeResult(FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_CONTEXTPATH,
					args);

				args = new Object[] { filterScopeModelImpl.getContextPath() };
	...
	protected FilterScope toUnwrappedModel(FilterScope filterScope) {
		...
		filterScopeImpl.setContextPath(filterScope.getContextPath());
