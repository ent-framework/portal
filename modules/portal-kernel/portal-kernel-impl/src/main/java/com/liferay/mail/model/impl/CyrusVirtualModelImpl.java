...
/**
 * The base model implementation for the CyrusVirtual service. Represents a row in the &quot;Mail_CyrusVirtual&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
...
public class CyrusVirtualModelImpl extends BaseModelImpl<CyrusVirtual>
     ...
     */
    public static final String TABLE_NAME = "Mail_CyrusVirtual";
    public static final Object[][] TABLE_COLUMNS = {
            { "emailAddress", Types.VARCHAR },
            { "userId", Types.VARCHAR }
        };
    public static final String TABLE_SQL_CREATE = "create table Mail_CyrusVirtual (emailAddress VARCHAR(75) not null primary key,userId VARCHAR(75) null)";
    public static final String TABLE_SQL_DROP = "drop table Mail_CyrusVirtual";
    public static final String ORDER_BY_JPQL = " ORDER BY cyrusVirtual.emailAddress ASC";
    public static final String ORDER_BY_SQL = " ORDER BY Mail_CyrusVirtual.emailAddress ASC";
