 ...
 */
public class PortalI18nFactorySet extends FactorySet {

	/**
	 * Commons Logging instance.
	 */
	protected static Log log = LogFactory.getLog(PortalI18nFactorySet.class);
	 ...
	 */
	public PortalI18nFactorySet(ServletContext servletContext, Map properties)
	...
	private XmlDefinitionsSet parseXmlFile(
		...
		try {
			...
			InputStream input = PortalClassLoaderUtil.getClassLoader().getResourceAsStream(filename);
