...
public class FilterScopeModelImpl extends BaseModelImpl<FilterScope>
	...
	public static final Object[][] TABLE_COLUMNS = {
			...
			{ "contextPath", Types.VARCHAR }
		};
	public static final String TABLE_SQL_CREATE = "create table FilterScope (filterScopeId LONG not null primary key,filterName VARCHAR(255) null,className VARCHAR(255) null,contextPath VARCHAR(75) null)";
	...
	public static long CONTEXTPATH_COLUMN_BITMASK = 2L;
	public static long FILTERNAME_COLUMN_BITMASK = 4L;
	...
	public void setContextPath(String contextPath) {
		_columnBitmask |= CONTEXTPATH_COLUMN_BITMASK;

		if (_originalContextPath == null) {
			_originalContextPath = _contextPath;
		}
	...
	public String getOriginalContextPath() {
		return GetterUtil.getString(_originalContextPath);
	}
	...
	public Object clone() {
		...
		filterScopeImpl.setContextPath(getContextPath());
	...
	public void resetOriginalValues() {
		...
		filterScopeModelImpl._originalContextPath = filterScopeModelImpl._contextPath;
	...
	public CacheModel<FilterScope> toCacheModel() {
		...
		filterScopeCacheModel.contextPath = getContextPath();

		String contextPath = filterScopeCacheModel.contextPath;

		if ((contextPath != null) && (contextPath.length() == 0)) {
			filterScopeCacheModel.contextPath = null;
		}
	...
	public String toXmlString() {
		...
		sb.append("]]></column-value></column>");
		sb.append(
			"<column><column-name>contextPath</column-name><column-value><![CDATA[");
		sb.append(getContextPath());
		sb.append("]]></column-value></column>");
