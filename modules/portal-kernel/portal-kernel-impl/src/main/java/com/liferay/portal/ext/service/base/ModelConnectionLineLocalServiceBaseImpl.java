...
import com.liferay.portal.ext.service.ModelConnectionLineLocalService;
...
/**
 * Provides the base implementation for the model connection line local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.liferay.portal.ext.service.impl.ModelConnectionLineLocalServiceImpl}.
 * </p>
 *
 * @author Jeff Qian
 ...
 * @generated
 */
public abstract class ModelConnectionLineLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements ModelConnectionLineLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.liferay.portal.ext.service.ModelConnectionLineLocalServiceUtil} to access the model connection line local service.
	 */
	...
	@Override
	public ModelConnectionLine addModelConnectionLine(
		ModelConnectionLine modelConnectionLine) throws SystemException {
		modelConnectionLine.setNew(true);

		return modelConnectionLinePersistence.update(modelConnectionLine);
	}
	 ...
	 */
	@Override
	public ModelConnectionLine createModelConnectionLine(long lineId) {
		return modelConnectionLinePersistence.create(lineId);
	}
	...
	@Override
	public ModelConnectionLine deleteModelConnectionLine(long lineId)
		throws PortalException, SystemException {
		return modelConnectionLinePersistence.remove(lineId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public ModelConnectionLine deleteModelConnectionLine(
		ModelConnectionLine modelConnectionLine) throws SystemException {
		return modelConnectionLinePersistence.remove(modelConnectionLine);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(ModelConnectionLine.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return modelConnectionLinePersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return modelConnectionLinePersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public ModelConnectionLine fetchModelConnectionLine(long lineId)
		throws SystemException {
		return modelConnectionLinePersistence.fetchByPrimaryKey(lineId);
	}
	 ...
	 */
	@Override
	public ModelConnectionLine getModelConnectionLine(long lineId)
		throws PortalException, SystemException {
		return modelConnectionLinePersistence.findByPrimaryKey(lineId);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return modelConnectionLinePersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<ModelConnectionLine> getModelConnectionLines(int start, int end)
		throws SystemException {
		return modelConnectionLinePersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getModelConnectionLinesCount() throws SystemException {
		return modelConnectionLinePersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public ModelConnectionLine updateModelConnectionLine(
		ModelConnectionLine modelConnectionLine) throws SystemException {
		return modelConnectionLinePersistence.update(modelConnectionLine);
	}
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("com.liferay.portal.ext.model.ModelConnectionLine",
			modelConnectionLineLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"com.liferay.portal.ext.model.ModelConnectionLine");
	}
