...
/**
 * The base model implementation for the CyrusUser service. Represents a row in the &quot;Mail_CyrusUser&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
...
public class CyrusUserModelImpl extends BaseModelImpl<CyrusUser>
     ...
     */
    public static final String TABLE_NAME = "Mail_CyrusUser";
    public static final Object[][] TABLE_COLUMNS = {
            { "userId", Types.VARCHAR },
            { "password_", Types.VARCHAR }
        };
    public static final String TABLE_SQL_CREATE = "create table Mail_CyrusUser (userId VARCHAR(75) not null primary key,password_ VARCHAR(75) null)";
    public static final String TABLE_SQL_DROP = "drop table Mail_CyrusUser";
    public static final String ORDER_BY_JPQL = " ORDER BY cyrusUser.userId ASC";
    public static final String ORDER_BY_SQL = " ORDER BY Mail_CyrusUser.userId ASC";
