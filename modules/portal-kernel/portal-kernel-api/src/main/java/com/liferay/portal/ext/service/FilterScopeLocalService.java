...
/**
 * Provides the local service interface for FilterScope. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Jeff Qian
 * @see FilterScopeLocalServiceUtil
...
public interface FilterScopeLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link FilterScopeLocalServiceUtil} to access the filter scope local service. Add custom service methods to {@link com.liferay.portal.ext.service.impl.FilterScopeLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
