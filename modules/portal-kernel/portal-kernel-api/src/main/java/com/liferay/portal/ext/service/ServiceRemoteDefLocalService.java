...
/**
 * Provides the local service interface for ServiceRemoteDef. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Jeff Qian
 * @see ServiceRemoteDefLocalServiceUtil
...
public interface ServiceRemoteDefLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link ServiceRemoteDefLocalServiceUtil} to access the service remote def local service. Add custom service methods to {@link com.liferay.portal.ext.service.impl.ServiceRemoteDefLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
