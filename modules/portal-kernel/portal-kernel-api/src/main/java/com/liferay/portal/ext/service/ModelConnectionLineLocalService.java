...
/**
 * Provides the local service interface for ModelConnectionLine. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Jeff Qian
 * @see ModelConnectionLineLocalServiceUtil
...
public interface ModelConnectionLineLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link ModelConnectionLineLocalServiceUtil} to access the model connection line local service. Add custom service methods to {@link com.liferay.portal.ext.service.impl.ModelConnectionLineLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
