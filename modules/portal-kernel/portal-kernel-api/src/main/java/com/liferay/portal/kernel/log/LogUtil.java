...
public class LogUtil {
    ...
    public static void debug(Logger log, Properties props) {
    ...
    public static void log(Logger log, Throwable throwable, String message) {
        if (throwable == null) {
        ...
        if (stackTraceElements.length <= STACK_TRACE_LENGTH) {
            if (Validator.isNotNull(message)) {
                ...
                log.error(causeThrowable.getMessage());
            }
