...
/**
 * The persistence utility for the service authorization service. This utility wraps {@link ServiceAuthorizationPersistenceImpl} and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
 ...
 */
@ProviderType
public class ServiceAuthorizationUtil {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 ...
	 */
	public static void clearCache(ServiceAuthorization serviceAuthorization) {
		getPersistence().clearCache(serviceAuthorization);
	}
	 ...
	 */
	public static List<ServiceAuthorization> findWithDynamicQuery(
	 ...
	 */
	public static ServiceAuthorization update(
		ServiceAuthorization serviceAuthorization) throws SystemException {
		return getPersistence().update(serviceAuthorization);
	}
	 ...
	 */
	public static ServiceAuthorization update(
		ServiceAuthorization serviceAuthorization, ServiceContext serviceContext)
		throws SystemException {
		return getPersistence().update(serviceAuthorization, serviceContext);
	}
	...
	*/
	public static com.liferay.portal.ext.model.ServiceAuthorization findByCode(
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.liferay.portal.ext.model.ServiceAuthorization fetchByCode(
		java.lang.String code)
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.liferay.portal.ext.model.ServiceAuthorization removeByCode(
		java.lang.String code)
		throws com.liferay.portal.ext.NoSuchServiceAuthorizationException,
			com.liferay.portal.kernel.exception.SystemException {
	...
	*/
	public static void cacheResult(
		...
		getPersistence().cacheResult(serviceAuthorization);
	}
	...
	*/
	public static void cacheResult(
		...
		getPersistence().cacheResult(serviceAuthorizations);
	}
	...
	*/
	public static com.liferay.portal.ext.model.ServiceAuthorization create(
		long authId) {
		return getPersistence().create(authId);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.liferay.portal.ext.model.ServiceAuthorization remove(
		long authId)
		throws com.liferay.portal.ext.NoSuchServiceAuthorizationException,
			com.liferay.portal.kernel.exception.SystemException {
		return getPersistence().remove(authId);
	}

	public static com.liferay.portal.ext.model.ServiceAuthorization updateImpl(
		com.liferay.portal.ext.model.ServiceAuthorization serviceAuthorization)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getPersistence().updateImpl(serviceAuthorization);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.liferay.portal.ext.model.ServiceAuthorization findByPrimaryKey(
		long authId)
		throws com.liferay.portal.ext.NoSuchServiceAuthorizationException,
			com.liferay.portal.kernel.exception.SystemException {
		return getPersistence().findByPrimaryKey(authId);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.liferay.portal.ext.model.ServiceAuthorization fetchByPrimaryKey(
		long authId) throws com.liferay.portal.kernel.exception.SystemException {
		return getPersistence().fetchByPrimaryKey(authId);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static java.util.List<com.liferay.portal.ext.model.ServiceAuthorization> findAll()
		throws com.liferay.portal.kernel.exception.SystemException {
	...
	*/
	...
	public static ServiceAuthorizationPersistence getPersistence() {
		if (_persistence == null) {
			_persistence = (ServiceAuthorizationPersistence)PortalBeanLocatorUtil.locate(ServiceAuthorizationPersistence.class.getName());

			ReferenceRegistry.registerReference(ServiceAuthorizationUtil.class,
				"_persistence");
		}
	 ...
	 */
	public void setPersistence(ServiceAuthorizationPersistence persistence) {
	}

	private static ServiceAuthorizationPersistence _persistence;
}