...
public class ClusterLinkUtil {
	 ...
	 */
	public static final String CLUSTER_FORWARD_MESSAGE = ClusterLink.CLUSTER_FORWARD_MESSAGE;
	...
	private static final Logger _log = LoggerFactory.getLogger(ClusterLinkUtil.class);
