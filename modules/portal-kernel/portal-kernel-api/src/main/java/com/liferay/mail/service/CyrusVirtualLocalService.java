...
/**
 * Provides the local service interface for CyrusVirtual. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see CyrusVirtualLocalServiceUtil
...
public interface CyrusVirtualLocalService extends BaseLocalService,
    PersistedModelLocalService {
    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this interface directly. Always use {@link CyrusVirtualLocalServiceUtil} to access the cyrus virtual local service. Add custom service methods to {@link com.liferay.mail.service.impl.CyrusVirtualLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
     */
