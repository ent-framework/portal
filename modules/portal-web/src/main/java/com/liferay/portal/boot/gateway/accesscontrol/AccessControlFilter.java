package com.liferay.portal.boot.gateway.accesscontrol;
...
public class AccessControlFilter extends ZuulFilter {
    ...
    private final LiferayPortalProperties liferayPortalProperties;

    public AccessControlFilter(RouteLocator routeLocator, LiferayPortalProperties liferayPortalProperties) {
        this.routeLocator = routeLocator;
        this.liferayPortalProperties = liferayPortalProperties;
    }
    ...
    private boolean isAuthorizedRequest(String serviceUrl, String serviceName, String requestUri) {
        Map<String, List<String>> authorizedMicroservicesEndpoints = liferayPortalProperties.getGateway().getAuthorizedMicroservicesEndpoints();
