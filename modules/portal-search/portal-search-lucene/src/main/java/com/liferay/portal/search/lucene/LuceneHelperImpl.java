...
public class LuceneHelperImpl implements LuceneHelper {
	...
	private static final long _CLUSTER_LINK_NODE_BOOTUP_RESPONSE_TIMEOUT =  GetterUtil.getLong(PropsUtil.get(PropsKeys.CLUSTER_LINK_NODE_BOOTUP_RESPONSE_TIMEOUT));

	private static final int _LUCENE_BOOLEAN_QUERY_CLAUSE_MAX_SIZE =
		GetterUtil.getInteger(
			PropsUtil.get(com.liferay.portal.search.lucene.props.PropsKeys.LUCENE_BOOLEAN_QUERY_CLAUSE_MAX_SIZE),
	...
	private static MethodKey _createTokenMethodKey = new MethodKey(TransientTokenUtil.class, "createToken", long.class);
