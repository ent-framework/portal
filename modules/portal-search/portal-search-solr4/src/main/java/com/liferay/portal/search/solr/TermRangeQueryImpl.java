...
public class TermRangeQueryImpl extends BaseQueryImpl
	...
	public TermRangeQueryImpl(
		...
		_termRangeQuery = new org.apache.lucene.search.TermRangeQuery(field, new BytesRef(lowerTerm.getBytes()), new BytesRef(upperTerm.getBytes()), includesLower, includesUpper);
	}
	...
	public String getLowerTerm() {
		return _termRangeQuery.getLowerTerm().toString();
	}
	...
	public String getUpperTerm() {
		return _termRangeQuery.getUpperTerm().toString();
	}
