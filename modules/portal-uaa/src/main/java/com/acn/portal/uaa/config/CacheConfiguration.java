package com.acn.portal.uaa.config;
...
public class CacheConfiguration {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("portal_uaa");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("portal_uaa");
        ...
        config.getMapConfigs().put("com.acn.portal.uaa.domain.*", initializeDomainMapConfig(jHipsterProperties));
