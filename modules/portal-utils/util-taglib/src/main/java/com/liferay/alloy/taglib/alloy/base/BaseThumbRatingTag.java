...
public abstract class BaseThumbRatingTag
  extends IncludeTag
{
  protected static final String _ATTRIBUTE_NAMESPACE = "alloy:thumb-rating:";
  private static final String _PAGE = "/html/taglib/alloy/thumb_rating/page.jsp";
  
  public int doStartTag()
    throws JspException
  {
    setAttributeNamespace("alloy:thumb-rating:");
  ...
  public String getThumbratingId() {
    return this._thumbratingId;
  }
  ...
  public String getThumbratingValue() {
    return this._thumbratingValue;
  }
  ...
  public void setThumbratingId(String thumbratingId) {
    this._thumbratingId = thumbratingId;
  ...
  public void setThumbratingValue(String thumbratingValue) {
    this._thumbratingValue = thumbratingValue;
  ...
  protected void cleanUp()
  {
    ...
    this._size = Integer.valueOf(2);
    this._srcNode = null;
    this._strings = null;
    this._tabIndex = Integer.valueOf(0);
    this._title = null;
    this._useARIA = true;
    this._thumbratingValue = null;
    this._visible = true;
    this._width = null;
  ...
  {
    return "/html/taglib/alloy/thumb_rating/page.jsp";
  }
  ...
  protected void setAttributes(HttpServletRequest request)
  {
    ...
    setNamespacedAttribute(request, "thumbratingId", this._thumbratingId);
    ...
    setNamespacedAttribute(request, "thumbratingValue", this._thumbratingValue);
  ...
  private String _thumbratingId = null;
  ...
  private Object _size = Integer.valueOf(2);
  ...
  private String _thumbratingValue = null;
