...
public abstract class BaseTooltipTag
  extends IncludeTag
{
  protected static final String _ATTRIBUTE_NAMESPACE = "alloy:tooltip:";
  private static final String _PAGE = "/html/taglib/alloy/tooltip/page.jsp";
  
  public int doStartTag()
    throws JspException
  {
    setAttributeNamespace("alloy:tooltip:");
  ...
  public Object getTooltipBodyContent() {
    return this._tooltipBodyContent;
  }
  ...
  public void setTooltipBodyContent(Object tooltipBodyContent) {
    this._tooltipBodyContent = tooltipBodyContent;
  ...
  public void setTitle(boolean title) {
    ...
    setScopedAttribute("title", Boolean.valueOf(title));
  }
  ...
  protected void cleanUp()
  {
    ...
    this._hideDelay = Integer.valueOf(500);
  ...
  {
    return "/html/taglib/alloy/tooltip/page.jsp";
  }
  ...
  protected void setAttributes(HttpServletRequest request)
  {
    ...
    setNamespacedAttribute(request, "tooltipBodyContent", this._tooltipBodyContent);
    ...
    setNamespacedAttribute(request, "tooltipId", this._tooltipId);
    ...
    setNamespacedAttribute(request, "title", Boolean.valueOf(this._title));
  ...
  private Object _tooltipBodyContent = null;
  ...
  private Object _hideDelay = Integer.valueOf(500);
