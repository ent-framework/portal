...
public abstract class BaseOverlayBaseTag
        extends IncludeTag {
    protected static final String _ATTRIBUTE_NAMESPACE = "alloy:overlay-base:";
    private static final String _PAGE = "/html/taglib/alloy/overlay_base/page.jsp";
    private Object _align = null;
    private Object _alignOn = null;
    private Object _overlaybaseBodyContent = null;
    ...
    private String _overlaybaseId = null;
    ...
    public int doStartTag()
            throws JspException {
        setAttributeNamespace("alloy:overlay-base:");
    ...
    public Object getOverlaybaseBodyContent() {
        return this._overlaybaseBodyContent;
    }

    public void setOverlaybaseBodyContent(Object overlaybaseBodyContent) {
        this._overlaybaseBodyContent = overlaybaseBodyContent;
    ...
    public String getOverlaybaseId() {
        return this._overlaybaseId;
    }

    public void setOverlaybaseId(String overlaybaseId) {
        this._overlaybaseId = overlaybaseId;
    ...
    protected void cleanUp() {
        ...
        this._align = null;
        this._alignOn = null;
        this._overlaybaseBodyContent = null;
    ...
    protected String getPage() {
        return "/html/taglib/alloy/overlay_base/page.jsp";
    }

    protected void setAttributes(HttpServletRequest request) {
        setNamespacedAttribute(request, "align", this._align);
        setNamespacedAttribute(request, "alignOn", this._alignOn);
        setNamespacedAttribute(request, "overlaybaseBodyContent", this._overlaybaseBodyContent);
        ...
        setNamespacedAttribute(request, "overlaybaseId", this._overlaybaseId);
