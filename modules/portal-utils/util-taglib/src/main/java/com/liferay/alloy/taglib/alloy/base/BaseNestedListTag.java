...
public abstract class BaseNestedListTag
        extends IncludeTag {
    protected static final String _ATTRIBUTE_NAMESPACE = "alloy:nested-list:";
    private static final String _PAGE = "/html/taglib/alloy/nested_list/page.jsp";
    ...
    public int doStartTag()
            throws JspException {
        setAttributeNamespace("alloy:nested-list:");
    ...
    protected String getPage() {
        return "/html/taglib/alloy/nested_list/page.jsp";
    }
