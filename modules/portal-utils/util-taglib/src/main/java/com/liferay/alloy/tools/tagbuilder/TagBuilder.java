...
public class TagBuilder
{
  ...
  protected String[] getAuthorList(Element element) { List<String> authors = new ArrayList();
  ...
  protected Element getComponentNode(Document doc, String name) { List<Element> components = doc.getRootElement().elements("component");
  ...
  protected List<Component> getComponents(Document doc) throws Exception { Element root = doc.getRootElement();
  ...
  protected Document getComponentsDocByShortName(String name) { for (Document doc : this._componentsExtDoc) {
  ...
  private String _templatesDir; protected Map<String, Object> getDefaultTemplateContext() { Map<String, Object> context = new HashMap();
  ...
  private void _create() throws Exception { List<Component> components = getAllComponents();
  ...
  private void _createBaseTag(Component component, Map<String, Object> context) throws Exception { StringBuilder sb = new StringBuilder();
